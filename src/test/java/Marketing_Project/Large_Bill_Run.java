...
public class Large_Bill_Run  extends ExtentReport {
...
extentTest = extent.startTest("Add_First_Customer_and_Service");
	...
	public void Add_Third_Customer_and_Service() throws Exception{
		extentTest = extent.startTest("Add_Third_Customer_and_Service");
	...
	{
		extentTest = extent.startTest("Add_Metering_Third_Customer");
...
//		Assert.assertEquals(actmessage, expmessage);
	...
	public void Rebill_with_new_Statement() throws Exception{
		extentTest = extent.startTest("Rebill_with_new_Statement");
		  ...
		  action_obj = new Repo_testing(driver); Assertion_obj = new
		  Assertion_Test(driver); executor = (JavascriptExecutor) driver;
		  driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		  Thread.sleep(5000); //Search the customer
		  action_obj.Searchfield().sendKeys(resi2);
		
		  Thread.sleep(2000); action_obj.SearchButton().click();
		  
		  Thread.sleep(2000); //Click on Statement Tab
		  action_obj.Statement_Tab().click(); Thread.sleep(2000);
		  
		  statementNo2 =
		  driver.findElement(By.xpath("//tr[@class='odd']/td[1]")).getText();
		 
		  //Click on View Details action_obj.View_Details().click();
		  Thread.sleep(2000);
		
		  //Click on Rollback Button action_obj.Rollback_Button().click();
		  Thread.sleep(1000);
		 ...
		 Thread.sleep(1000);
		  ...
		  //Click on OK button action_obj.Ok_Button().click(); Thread.sleep(4000);
		 
		  //Assert Information Message Assertion_obj.Assertion_Information_Popup();
		  Thread.sleep(1000);
		  ...
		  actmessage =
		  driver.findElement(By.xpath("//div[@class='bootstrap-dialog-body']/div")).
		  getText(); expmessage = "Rollback for customer " + resi2 +" and statement " +
		  statementNo2 + " has been successful.";
		  
		  Assert.assertEquals(actmessage, expmessage); Thread.sleep(1000);
		  
		  //Close the popup action_obj.Close_IconB().click(); Thread.sleep(2000);
		 
		  //Click on ViewRollback History action_obj.View_Rollback_History().click();
		  Thread.sleep(1000);
		  
		 
		  //Click on Rebill Button action_obj.Rebill_Button().click();
		  
		  //Click on toggle button action_obj.Statement_Toggle().click();
		 
		  //Click on Run bill button action_obj.Run_Bill_2().click();
		  Thread.sleep(1000);
		 
		 //Assert Rebill result Popup //Assertion_obj.Assert_Result_Popup();
		  //Thread.sleep(1000);
		  
		  //Close the popup action_obj.Close_Icon2().click(); Thread.sleep(1000);
		  
		  newStatementNo=
		  driver.findElement(By.xpath("//tr[@class='odd']/td[8]")).getText();
		 
		//Click on Bill Run Tab action_obj.Bill_Run().click();
		 
		//Click on Bill Run Search Button action_obj.Bill_Run_Search().click();
		  Thread.sleep(1000);
		 ...
		 statementNoBR =
		  ...
		  Assert.assertEquals(newStatementNo, statementNoBR); Thread.sleep(2000);
		 
		 //View Bill Run Details //action_obj.View_Details().click();
		  //Thread.sleep(2000);
